...
print("\n2️⃣ VERIFICA CONTRATTO SULLA CHAIN")
if contract_address:
    try:
        ...
        if len(code) <= 2:  # '0x' = nessun codice
            print(f"   ⚠️ WARNING: Nessun bytecode all'indirizzo!")
    ...
    print(f"   ⚠️ Nessun indirizzo da verificare")
...
print("\n4️⃣ VERIFICA CARICAMENTO CONTRATTO")
try:
